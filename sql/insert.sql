-- 1) Setjum inn flokka (categories)
...
((SELECT id FROM spurningar WHERE spurning = 'Í <head> á vefjum setjum við <meta charset="utf-8"> (eða það stafasett sem nota á), af hverju er það gert?'), 'Ekkert af þessu.', false)
ON CONFLICT (svor_text) DO NOTHING;
